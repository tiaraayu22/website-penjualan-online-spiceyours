...
class Register extends CI_Controller {
    ...
    public function verify()
    {
        ...
        $this->form_validation->set_rules('cities', 'Kota', 'required');
    ...
    public function getCity()
    {
        ...
        $data = $this->db->query("SELECT id, concat(city_name, ', ' ,a.type,' ' , province  ) as text FROM cities a where id is not null and (province like '%".$_GET['q']."%' or city_name like '%".$_GET['q']."%')")->result();
