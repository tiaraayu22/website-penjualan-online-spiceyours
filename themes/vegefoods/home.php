...
<section id="home-section" class="hero">
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/hijau.jpg'); ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

          <div class="col-md-12 ftco-animate text-center">
            <h1 class="mb-2">Spiceyours</h1>
            <h2 class="subheading mb-4">Menjual Gelang Home-made Dengan Harga Terjangkau</h2>
    ...
    <div class="slider-item" style="background-image: url(<?php echo get_theme_uri('images/pink.jpg'); ?>);">
        <div class="overlay"></div>
      <div class="container">
        <div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">
          ...
          <div class="col-sm-12 ftco-animate text-center">
            ...
            <h2 class="subheading mb-4">Barang Yang Dijual Cocok Untuk Semua Kalangan</h2>
            <p><a href="#products" class="btn btn-info">Belanja Sekarang</a></p>
          </div>
...
<section class="ftco-section" id="products">
  ...
  <div class="container">
    ...
    <div class="col-md-12 heading-section text-center ftco-animate">
        <span class="subheading">Produk Gelang</span>
...
<section class="ftco-section img" style="background-image: url(<?php echo get_theme_uri('images/dotd.jpg'); ?>); color: #000000;">
  <div class="container">
    <div class="row justify-content-end">
      <div class="col-md-6 heading-section ftco-animate deal-of-the-day ftco-animate">
        <span class="subheading" style="color: #000000;">Produk dengan Harga Terbaik</span>
        <h2 class="mb-4" style="color: #000000;">Deal of the day</h2>
        <p style="color: #000000;">Gelang terbuat dari benang wol</p>
        <h3><a href="#" style="color: #000000;">4 DAISY BRACELET</a></h3>
        <span class="price" style="color: #000000;">Rp 32.000,00 <a href="#" style="color: #000000;">sekarang hanya Rp 30.000,00</a></span>
